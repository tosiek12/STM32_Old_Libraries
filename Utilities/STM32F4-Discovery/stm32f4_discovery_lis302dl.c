...
static void LIS302DL_LowLevel_Init(void)
{
  ...
  GPIO_InitStructure.GPIO_PuPd  = GPIO_PuPd_NOPULL;	//bylo GPIO_PuPd_DOWN
  ...
  SPI_InitStructure.SPI_DataSize = SPI_DataSize_8b;	//bylo8
  SPI_InitStructure.SPI_CPOL = SPI_CPOL_High;	//bylo: SPI_CPOL_Low
  SPI_InitStructure.SPI_CPHA = SPI_CPHA_2Edge;	//bylo: SPI_CPHA_1Edge
  SPI_InitStructure.SPI_NSS = SPI_NSS_Soft;
  SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_32;	//bylo 4
  SPI_InitStructure.SPI_FirstBit = SPI_FirstBit_MSB;
  SPI_InitStructure.SPI_CRCPolynomial = 0;	//bylo 7
